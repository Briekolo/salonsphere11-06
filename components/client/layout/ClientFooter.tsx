...
export function ClientFooter() {
  // TODO: Get tenant info from context
  const tenant = {
    name: 'Salon Name',
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Uw vertrouwde salon voor alle beauty behandelingen. 
              Professioneel, persoonlijk en altijd de beste service.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-1 text-gray-400 text-sm">
              {tenant.businessHours.map((schedule) => (
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
            <p>© {currentYear} {tenant.name}. Alle rechten voorbehouden.</p>
